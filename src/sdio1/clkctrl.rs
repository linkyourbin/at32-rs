...
impl W {
    ...
    #[doc = "Bit 8 - Clock output enable"]
    #[inline(always)]
    pub fn clkoen(&mut self) -> ClkoenW<'_, ClkctrlSpec> {
        ClkoenW::new(self, 8)
    }
    #[doc = "Bit 9 - Power saving mode enable"]
    #[inline(always)]
    pub fn pwrsven(&mut self) -> PwrsvenW<'_, ClkctrlSpec> {
        PwrsvenW::new(self, 9)
    }
    #[doc = "Bit 10 - Clock divider bypass enable bit"]
    #[inline(always)]
    pub fn bypsen(&mut self) -> BypsenW<'_, ClkctrlSpec> {
        BypsenW::new(self, 10)
    }
    #[doc = "Bits 11:12 - Bus width selection"]
    #[inline(always)]
    pub fn busws(&mut self) -> BuswsW<'_, ClkctrlSpec> {
        BuswsW::new(self, 11)
    }
    #[doc = "Bit 13 - SDIO_CK edge selection bit"]
    #[inline(always)]
    pub fn clkeds(&mut self) -> ClkedsW<'_, ClkctrlSpec> {
        ClkedsW::new(self, 13)
    }
    #[doc = "Bit 14 - Hardware flow control enable"]
    #[inline(always)]
    pub fn hfcen(&mut self) -> HfcenW<'_, ClkctrlSpec> {
        HfcenW::new(self, 14)
    }
    #[doc = "Bits 15:16 - Clock divide factor bit9 and bit8"]
    #[inline(always)]
    pub fn clkdiv98(&mut self) -> Clkdiv98W<'_, ClkctrlSpec> {
