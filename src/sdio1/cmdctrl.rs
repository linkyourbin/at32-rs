...
impl W {
    #[doc = "Bits 0:5 - CMDIDX"]
    #[inline(always)]
    pub fn cmdidx(&mut self) -> CmdidxW<'_, CmdctrlSpec> {
        CmdidxW::new(self, 0)
    }
    #[doc = "Bits 6:7 - Wait for response"]
    #[inline(always)]
    pub fn rspwt(&mut self) -> RspwtW<'_, CmdctrlSpec> {
        RspwtW::new(self, 6)
    }
    #[doc = "Bit 8 - CCSM wait for interrupt"]
    #[inline(always)]
    pub fn intwt(&mut self) -> IntwtW<'_, CmdctrlSpec> {
        IntwtW::new(self, 8)
    }
    #[doc = "Bit 9 - CCSM wait for end of transfer"]
    #[inline(always)]
    pub fn pndwt(&mut self) -> PndwtW<'_, CmdctrlSpec> {
        PndwtW::new(self, 9)
    }
    #[doc = "Bit 10 - Command channel state machine"]
    #[inline(always)]
    pub fn ccsmen(&mut self) -> CcsmenW<'_, CmdctrlSpec> {
        CcsmenW::new(self, 10)
    }
    #[doc = "Bit 11 - SD I/O suspend command"]
    #[inline(always)]
    pub fn iosusp(&mut self) -> IosuspW<'_, CmdctrlSpec> {
        IosuspW::new(self, 11)
    }
}
