...
impl W {
    #[doc = "Bits 0:1 - Port n.0 mode configurate bits"]
    #[inline(always)]
    pub fn iomc0(&mut self) -> Iomc0W<'_, CfglrSpec> {
        Iomc0W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Port n.0 function configurate bits"]
    #[inline(always)]
    pub fn iofc0(&mut self) -> Iofc0W<'_, CfglrSpec> {
        Iofc0W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Port n.1 mode configurate bits"]
    #[inline(always)]
    pub fn iomc1(&mut self) -> Iomc1W<'_, CfglrSpec> {
        Iomc1W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Port n.1 function configurate bits"]
    #[inline(always)]
    pub fn iofc1(&mut self) -> Iofc1W<'_, CfglrSpec> {
        Iofc1W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Port n.2 mode configurate bits"]
    #[inline(always)]
    pub fn iomc2(&mut self) -> Iomc2W<'_, CfglrSpec> {
        Iomc2W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Port n.2 function configurate bits"]
    #[inline(always)]
    pub fn iofc2(&mut self) -> Iofc2W<'_, CfglrSpec> {
        Iofc2W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Port n.3 mode configurate bits"]
    #[inline(always)]
    pub fn iomc3(&mut self) -> Iomc3W<'_, CfglrSpec> {
        Iomc3W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Port n.3 function configurate bits"]
    #[inline(always)]
    pub fn iofc3(&mut self) -> Iofc3W<'_, CfglrSpec> {
        Iofc3W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Port n.4 mode configurate bits"]
    #[inline(always)]
    pub fn iomc4(&mut self) -> Iomc4W<'_, CfglrSpec> {
        Iomc4W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Port n.4 function configurate bits"]
    #[inline(always)]
    pub fn iofc4(&mut self) -> Iofc4W<'_, CfglrSpec> {
        Iofc4W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Port n.5 mode configurate bits"]
    #[inline(always)]
    pub fn iomc5(&mut self) -> Iomc5W<'_, CfglrSpec> {
        Iomc5W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Port n.5 function configurate bits"]
    #[inline(always)]
    pub fn iofc5(&mut self) -> Iofc5W<'_, CfglrSpec> {
        Iofc5W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Port n.6 mode configurate bits"]
    #[inline(always)]
    pub fn iomc6(&mut self) -> Iomc6W<'_, CfglrSpec> {
        Iomc6W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Port n.6 function configurate bits"]
    #[inline(always)]
    pub fn iofc6(&mut self) -> Iofc6W<'_, CfglrSpec> {
        Iofc6W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Port n.7 mode configurate bits"]
    #[inline(always)]
    pub fn iomc7(&mut self) -> Iomc7W<'_, CfglrSpec> {
        Iomc7W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Port n.7 function configurate bits"]
    #[inline(always)]
    pub fn iofc7(&mut self) -> Iofc7W<'_, CfglrSpec> {
        Iofc7W::new(self, 30)
    }
}
