...
impl W {
    #[doc = "Bits 0:1 - Port n.8 mode configurate bits"]
    #[inline(always)]
    pub fn iomc8(&mut self) -> Iomc8W<'_, CfghrSpec> {
        Iomc8W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Port n.8 function configurate bits"]
    #[inline(always)]
    pub fn iofc8(&mut self) -> Iofc8W<'_, CfghrSpec> {
        Iofc8W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Port n.9 mode configurate bits"]
    #[inline(always)]
    pub fn iomc9(&mut self) -> Iomc9W<'_, CfghrSpec> {
        Iomc9W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Port n.9 function configurate bits"]
    #[inline(always)]
    pub fn iofc9(&mut self) -> Iofc9W<'_, CfghrSpec> {
        Iofc9W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Port n.10 mode configurate bits"]
    #[inline(always)]
    pub fn iomc10(&mut self) -> Iomc10W<'_, CfghrSpec> {
        Iomc10W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Port n.10 function configurate bits"]
    #[inline(always)]
    pub fn iofc10(&mut self) -> Iofc10W<'_, CfghrSpec> {
        Iofc10W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Port n.11 mode configurate bits"]
    #[inline(always)]
    pub fn iomc11(&mut self) -> Iomc11W<'_, CfghrSpec> {
        Iomc11W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Port n.11 function configurate bits"]
    #[inline(always)]
    pub fn iofc11(&mut self) -> Iofc11W<'_, CfghrSpec> {
        Iofc11W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Port n.12 mode configurate bits"]
    #[inline(always)]
    pub fn iomc12(&mut self) -> Iomc12W<'_, CfghrSpec> {
        Iomc12W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Port n.12 function configurate bits"]
    #[inline(always)]
    pub fn iofc12(&mut self) -> Iofc12W<'_, CfghrSpec> {
        Iofc12W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Port n.13 mode configurate bits"]
    #[inline(always)]
    pub fn iomc13(&mut self) -> Iomc13W<'_, CfghrSpec> {
        Iomc13W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Port n.13 function configurate bits"]
    #[inline(always)]
    pub fn iofc13(&mut self) -> Iofc13W<'_, CfghrSpec> {
        Iofc13W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Port n.14 mode configurate bits"]
    #[inline(always)]
    pub fn iomc14(&mut self) -> Iomc14W<'_, CfghrSpec> {
        Iomc14W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Port n.14 function configurate bits"]
    #[inline(always)]
    pub fn iofc14(&mut self) -> Iofc14W<'_, CfghrSpec> {
        Iofc14W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Port n.15 mode configurate bits"]
    #[inline(always)]
    pub fn iomc15(&mut self) -> Iomc15W<'_, CfghrSpec> {
        Iomc15W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Port n.15 function configurate bits"]
    #[inline(always)]
    pub fn iofc15(&mut self) -> Iofc15W<'_, CfghrSpec> {
        Iofc15W::new(self, 30)
    }
}
