...
impl W {
    #[doc = "Bits 0:3 - Address setup time"]
    #[inline(always)]
    pub fn addrst(&mut self) -> AddrstW<'_, Bk1tmgwr4Spec> {
        AddrstW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Address-hold time"]
    #[inline(always)]
    pub fn addrht(&mut self) -> AddrhtW<'_, Bk1tmgwr4Spec> {
        AddrhtW::new(self, 4)
    }
    #[doc = "Bits 8:15 - Asynchronous data setup time"]
    #[inline(always)]
    pub fn dtst(&mut self) -> DtstW<'_, Bk1tmgwr4Spec> {
        DtstW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Bus latency"]
    #[inline(always)]
    pub fn buslat(&mut self) -> BuslatW<'_, Bk1tmgwr4Spec> {
        BuslatW::new(self, 16)
    }
    #[doc = "Bits 28:29 - Asynchronous mode"]
    #[inline(always)]
    pub fn asyncm(&mut self) -> AsyncmW<'_, Bk1tmgwr4Spec> {
        AsyncmW::new(self, 28)
    }
}
