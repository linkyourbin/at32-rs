...
impl W {
    #[doc = "Bits 0:3 - Address setup time"]
    #[inline(always)]
    pub fn addrst(&mut self) -> AddrstW<'_, Bk1tmg1Spec> {
        AddrstW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Address-hold time"]
    #[inline(always)]
    pub fn addrht(&mut self) -> AddrhtW<'_, Bk1tmg1Spec> {
        AddrhtW::new(self, 4)
    }
    #[doc = "Bits 8:15 - Asynchronous data setup time"]
    #[inline(always)]
    pub fn dtst(&mut self) -> DtstW<'_, Bk1tmg1Spec> {
        DtstW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Bus latency"]
    #[inline(always)]
    pub fn buslat(&mut self) -> BuslatW<'_, Bk1tmg1Spec> {
        BuslatW::new(self, 16)
    }
    #[doc = "Bits 20:23 - Clock prescale"]
    #[inline(always)]
    pub fn clkpsc(&mut self) -> ClkpscW<'_, Bk1tmg1Spec> {
        ClkpscW::new(self, 20)
    }
    #[doc = "Bits 24:27 - Data latency"]
    #[inline(always)]
    pub fn dtlat(&mut self) -> DtlatW<'_, Bk1tmg1Spec> {
        DtlatW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Asynchronous mode"]
    #[inline(always)]
    pub fn asyncm(&mut self) -> AsyncmW<'_, Bk1tmg1Spec> {
        AsyncmW::new(self, 28)
    }
}
