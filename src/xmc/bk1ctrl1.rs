...
impl W {
    #[doc = "Bit 0 - Memory bank enable"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<'_, Bk1ctrl1Spec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - Address and data multiplexing enable"]
    #[inline(always)]
    pub fn admuxen(&mut self) -> AdmuxenW<'_, Bk1ctrl1Spec> {
        AdmuxenW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Memory device type"]
    #[inline(always)]
    pub fn dev(&mut self) -> DevW<'_, Bk1ctrl1Spec> {
        DevW::new(self, 2)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    pub fn extmdbw(&mut self) -> ExtmdbwW<'_, Bk1ctrl1Spec> {
        ExtmdbwW::new(self, 4)
    }
    #[doc = "Bit 6 - Nor flash access enable"]
    #[inline(always)]
    pub fn noren(&mut self) -> NorenW<'_, Bk1ctrl1Spec> {
        NorenW::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous burst enable"]
    #[inline(always)]
    pub fn syncben(&mut self) -> SyncbenW<'_, Bk1ctrl1Spec> {
        SyncbenW::new(self, 8)
    }
    #[doc = "Bit 9 - NWAIT polarity"]
    #[inline(always)]
    pub fn nwpol(&mut self) -> NwpolW<'_, Bk1ctrl1Spec> {
        NwpolW::new(self, 9)
    }
    #[doc = "Bit 10 - Wrapped enable"]
    #[inline(always)]
    pub fn wrapen(&mut self) -> WrapenW<'_, Bk1ctrl1Spec> {
        WrapenW::new(self, 10)
    }
    #[doc = "Bit 11 - Wait timing configuration"]
    #[inline(always)]
    pub fn nwtcfg(&mut self) -> NwtcfgW<'_, Bk1ctrl1Spec> {
        NwtcfgW::new(self, 11)
    }
    #[doc = "Bit 12 - Write enable"]
    #[inline(always)]
    pub fn wen(&mut self) -> WenW<'_, Bk1ctrl1Spec> {
        WenW::new(self, 12)
    }
    #[doc = "Bit 13 - NWAIT in synchronous transfer enable"]
    #[inline(always)]
    pub fn nwsen(&mut self) -> NwsenW<'_, Bk1ctrl1Spec> {
        NwsenW::new(self, 13)
    }
    #[doc = "Bit 14 - Read-write timing different"]
    #[inline(always)]
    pub fn rwtd(&mut self) -> RwtdW<'_, Bk1ctrl1Spec> {
        RwtdW::new(self, 14)
    }
    #[doc = "Bit 15 - NWAIT in asynchronous transfer enable"]
    #[inline(always)]
    pub fn nwasen(&mut self) -> NwasenW<'_, Bk1ctrl1Spec> {
        NwasenW::new(self, 15)
    }
    #[doc = "Bits 16:18 - CRAM page size"]
    #[inline(always)]
    pub fn crpgs(&mut self) -> CrpgsW<'_, Bk1ctrl1Spec> {
        CrpgsW::new(self, 16)
    }
    #[doc = "Bit 19 - Memory write mode control"]
    #[inline(always)]
    pub fn mwmc(&mut self) -> MwmcW<'_, Bk1ctrl1Spec> {
        MwmcW::new(self, 19)
    }
}
