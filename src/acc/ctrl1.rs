...
impl W {
    #[doc = "Bit 0 - Calibration on"]
    #[inline(always)]
    pub fn calon(&mut self) -> CalonW<'_, Ctrl1Spec> {
        CalonW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable trim"]
    #[inline(always)]
    pub fn entrim(&mut self) -> EntrimW<'_, Ctrl1Spec> {
        EntrimW::new(self, 1)
    }
    #[doc = "Bit 4 - RSLOST error interrupt enable"]
    #[inline(always)]
    pub fn eien(&mut self) -> EienW<'_, Ctrl1Spec> {
        EienW::new(self, 4)
    }
    #[doc = "Bit 5 - CALRDY interrupt enable"]
    #[inline(always)]
    pub fn calrdyien(&mut self) -> CalrdyienW<'_, Ctrl1Spec> {
        CalrdyienW::new(self, 5)
    }
    #[doc = "Bits 8:11 - STEP"]
    #[inline(always)]
    pub fn step(&mut self) -> StepW<'_, Ctrl1Spec> {
        StepW::new(self, 8)
    }
}
