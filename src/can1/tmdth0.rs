...
impl W {
    #[doc = "Bits 0:7 - Transmit mailbox data byte 4"]
    #[inline(always)]
    pub fn tmdt4(&mut self) -> Tmdt4W<'_, Tmdth0Spec> {
        Tmdt4W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Transmit mailbox data byte 5"]
    #[inline(always)]
    pub fn tmdt5(&mut self) -> Tmdt5W<'_, Tmdth0Spec> {
        Tmdt5W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Transmit mailbox data byte 6"]
    #[inline(always)]
    pub fn tmdt6(&mut self) -> Tmdt6W<'_, Tmdth0Spec> {
        Tmdt6W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Transmit mailbox data byte 7"]
    #[inline(always)]
    pub fn tmdt7(&mut self) -> Tmdt7W<'_, Tmdth0Spec> {
        Tmdt7W::new(self, 24)
    }
}
#[doc = "Transmit mailbox 0 high byte data register\n\nYou can [`read`](crate::Reg::read) this register and get [`tmdth0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tmdth0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
