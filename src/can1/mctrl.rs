...
impl W {
    #[doc = "Bit 0 - Freeze mode enable"]
    #[inline(always)]
    pub fn fzen(&mut self) -> FzenW<'_, MctrlSpec> {
        FzenW::new(self, 0)
    }
    #[doc = "Bit 1 - Doze mode enable"]
    #[inline(always)]
    pub fn dzen(&mut self) -> DzenW<'_, MctrlSpec> {
        DzenW::new(self, 1)
    }
    #[doc = "Bit 2 - Multiple message sending sequence rule"]
    #[inline(always)]
    pub fn mmssr(&mut self) -> MmssrW<'_, MctrlSpec> {
        MmssrW::new(self, 2)
    }
    #[doc = "Bit 3 - Message discarding rule select when overflow"]
    #[inline(always)]
    pub fn mdrsel(&mut self) -> MdrselW<'_, MctrlSpec> {
        MdrselW::new(self, 3)
    }
    #[doc = "Bit 4 - Prohibit retransmission when sending fails enable"]
    #[inline(always)]
    pub fn prsfen(&mut self) -> PrsfenW<'_, MctrlSpec> {
        PrsfenW::new(self, 4)
    }
    #[doc = "Bit 5 - Automatic exit doze mode enable"]
    #[inline(always)]
    pub fn aeden(&mut self) -> AedenW<'_, MctrlSpec> {
        AedenW::new(self, 5)
    }
    #[doc = "Bit 6 - Automatic exit bus-off enable"]
    #[inline(always)]
    pub fn aeboen(&mut self) -> AeboenW<'_, MctrlSpec> {
        AeboenW::new(self, 6)
    }
    #[doc = "Bit 7 - Time triggered communication mode enable"]
    #[inline(always)]
    pub fn ttcen(&mut self) -> TtcenW<'_, MctrlSpec> {
        TtcenW::new(self, 7)
    }
    #[doc = "Bit 15 - Software partial reset"]
    #[inline(always)]
    pub fn sprst(&mut self) -> SprstW<'_, MctrlSpec> {
        SprstW::new(self, 15)
    }
    #[doc = "Bit 16 - Prohibit transmission when debug"]
    #[inline(always)]
    pub fn ptd(&mut self) -> PtdW<'_, MctrlSpec> {
        PtdW::new(self, 16)
    }
}
