...
impl W {
    #[doc = "Bit 0 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel0(&mut self) -> Fmsel0W<'_, FmcfgSpec> {
        Fmsel0W::new(self, 0)
    }
    #[doc = "Bit 1 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel1(&mut self) -> Fmsel1W<'_, FmcfgSpec> {
        Fmsel1W::new(self, 1)
    }
    #[doc = "Bit 2 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel2(&mut self) -> Fmsel2W<'_, FmcfgSpec> {
        Fmsel2W::new(self, 2)
    }
    #[doc = "Bit 3 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel3(&mut self) -> Fmsel3W<'_, FmcfgSpec> {
        Fmsel3W::new(self, 3)
    }
    #[doc = "Bit 4 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel4(&mut self) -> Fmsel4W<'_, FmcfgSpec> {
        Fmsel4W::new(self, 4)
    }
    #[doc = "Bit 5 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel5(&mut self) -> Fmsel5W<'_, FmcfgSpec> {
        Fmsel5W::new(self, 5)
    }
    #[doc = "Bit 6 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel6(&mut self) -> Fmsel6W<'_, FmcfgSpec> {
        Fmsel6W::new(self, 6)
    }
    #[doc = "Bit 7 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel7(&mut self) -> Fmsel7W<'_, FmcfgSpec> {
        Fmsel7W::new(self, 7)
    }
    #[doc = "Bit 8 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel8(&mut self) -> Fmsel8W<'_, FmcfgSpec> {
        Fmsel8W::new(self, 8)
    }
    #[doc = "Bit 9 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel9(&mut self) -> Fmsel9W<'_, FmcfgSpec> {
        Fmsel9W::new(self, 9)
    }
    #[doc = "Bit 10 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel10(&mut self) -> Fmsel10W<'_, FmcfgSpec> {
        Fmsel10W::new(self, 10)
    }
    #[doc = "Bit 11 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel11(&mut self) -> Fmsel11W<'_, FmcfgSpec> {
        Fmsel11W::new(self, 11)
    }
    #[doc = "Bit 12 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel12(&mut self) -> Fmsel12W<'_, FmcfgSpec> {
        Fmsel12W::new(self, 12)
    }
    #[doc = "Bit 13 - Filter mode select"]
    #[inline(always)]
    pub fn fmsel13(&mut self) -> Fmsel13W<'_, FmcfgSpec> {
