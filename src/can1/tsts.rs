...
impl W {
    #[doc = "Bit 0 - Transmit mailbox 0 transmission complete flag"]
    #[inline(always)]
    pub fn tm0tcf(&mut self) -> Tm0tcfW<'_, TstsSpec> {
        Tm0tcfW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit mailbox 0 transmission success flag"]
    #[inline(always)]
    pub fn tm0tsf(&mut self) -> Tm0tsfW<'_, TstsSpec> {
        Tm0tsfW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit mailbox 0 arbitration lost flag"]
    #[inline(always)]
    pub fn tm0alf(&mut self) -> Tm0alfW<'_, TstsSpec> {
        Tm0alfW::new(self, 2)
    }
    #[doc = "Bit 3 - Transmit mailbox 0 transmission error flag"]
    #[inline(always)]
    pub fn tm0tef(&mut self) -> Tm0tefW<'_, TstsSpec> {
        Tm0tefW::new(self, 3)
    }
    #[doc = "Bit 7 - Transmit mailbox 0 cancel transmission"]
    #[inline(always)]
    pub fn tm0ct(&mut self) -> Tm0ctW<'_, TstsSpec> {
        Tm0ctW::new(self, 7)
    }
    #[doc = "Bit 8 - Transmit mailbox 1 transmission complete flag"]
    #[inline(always)]
    pub fn tm1tcf(&mut self) -> Tm1tcfW<'_, TstsSpec> {
        Tm1tcfW::new(self, 8)
    }
    #[doc = "Bit 9 - Transmit mailbox 1 transmission success flag"]
    #[inline(always)]
    pub fn tm1tsf(&mut self) -> Tm1tsfW<'_, TstsSpec> {
        Tm1tsfW::new(self, 9)
    }
    #[doc = "Bit 10 - Transmit mailbox 1 arbitration lost flag"]
    #[inline(always)]
    pub fn tm1alf(&mut self) -> Tm1alfW<'_, TstsSpec> {
        Tm1alfW::new(self, 10)
    }
    #[doc = "Bit 11 - Transmit mailbox 1 transmission error flag"]
    #[inline(always)]
    pub fn tm1tef(&mut self) -> Tm1tefW<'_, TstsSpec> {
        Tm1tefW::new(self, 11)
    }
    #[doc = "Bit 15 - Transmit mailbox 1 cancel transmission"]
    #[inline(always)]
    pub fn tm1ct(&mut self) -> Tm1ctW<'_, TstsSpec> {
        Tm1ctW::new(self, 15)
    }
    #[doc = "Bit 16 - transmit mailbox 2 transmission complete flag"]
    #[inline(always)]
    pub fn tm2tcf(&mut self) -> Tm2tcfW<'_, TstsSpec> {
        Tm2tcfW::new(self, 16)
    }
    #[doc = "Bit 17 - Transmit mailbox 2 transmission success flag"]
    #[inline(always)]
    pub fn tm2tsf(&mut self) -> Tm2tsfW<'_, TstsSpec> {
        Tm2tsfW::new(self, 17)
    }
    #[doc = "Bit 18 - Transmit mailbox 2 arbitration lost flag"]
    #[inline(always)]
    pub fn tm2alf(&mut self) -> Tm2alfW<'_, TstsSpec> {
        Tm2alfW::new(self, 18)
    }
    #[doc = "Bit 19 - Transmit mailbox 2 transmission error flag"]
    #[inline(always)]
    pub fn tm2tef(&mut self) -> Tm2tefW<'_, TstsSpec> {
        Tm2tefW::new(self, 19)
    }
    #[doc = "Bit 23 - Transmit mailbox 2 cancel transmission"]
    #[inline(always)]
    pub fn tm2ct(&mut self) -> Tm2ctW<'_, TstsSpec> {
        Tm2ctW::new(self, 23)
    }
}
