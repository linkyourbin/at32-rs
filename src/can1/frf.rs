...
impl W {
    #[doc = "Bit 0 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel0(&mut self) -> Frfsel0W<'_, FrfSpec> {
        Frfsel0W::new(self, 0)
    }
    #[doc = "Bit 1 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel1(&mut self) -> Frfsel1W<'_, FrfSpec> {
        Frfsel1W::new(self, 1)
    }
    #[doc = "Bit 2 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel2(&mut self) -> Frfsel2W<'_, FrfSpec> {
        Frfsel2W::new(self, 2)
    }
    #[doc = "Bit 3 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel3(&mut self) -> Frfsel3W<'_, FrfSpec> {
        Frfsel3W::new(self, 3)
    }
    #[doc = "Bit 4 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel4(&mut self) -> Frfsel4W<'_, FrfSpec> {
        Frfsel4W::new(self, 4)
    }
    #[doc = "Bit 5 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel5(&mut self) -> Frfsel5W<'_, FrfSpec> {
        Frfsel5W::new(self, 5)
    }
    #[doc = "Bit 6 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel6(&mut self) -> Frfsel6W<'_, FrfSpec> {
        Frfsel6W::new(self, 6)
    }
    #[doc = "Bit 7 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel7(&mut self) -> Frfsel7W<'_, FrfSpec> {
        Frfsel7W::new(self, 7)
    }
    #[doc = "Bit 8 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel8(&mut self) -> Frfsel8W<'_, FrfSpec> {
        Frfsel8W::new(self, 8)
    }
    #[doc = "Bit 9 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel9(&mut self) -> Frfsel9W<'_, FrfSpec> {
        Frfsel9W::new(self, 9)
    }
    #[doc = "Bit 10 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel10(&mut self) -> Frfsel10W<'_, FrfSpec> {
        Frfsel10W::new(self, 10)
    }
    #[doc = "Bit 11 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel11(&mut self) -> Frfsel11W<'_, FrfSpec> {
        Frfsel11W::new(self, 11)
    }
    #[doc = "Bit 12 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel12(&mut self) -> Frfsel12W<'_, FrfSpec> {
        Frfsel12W::new(self, 12)
    }
    #[doc = "Bit 13 - Filter relation FIFO select"]
    #[inline(always)]
    pub fn frfsel13(&mut self) -> Frfsel13W<'_, FrfSpec> {
