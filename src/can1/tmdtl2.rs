...
impl W {
    #[doc = "Bits 0:7 - Transmit mailbox data byte 0"]
    #[inline(always)]
    pub fn tmdt0(&mut self) -> Tmdt0W<'_, Tmdtl2Spec> {
        Tmdt0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Transmit mailbox data byte 1"]
    #[inline(always)]
    pub fn tmdt1(&mut self) -> Tmdt1W<'_, Tmdtl2Spec> {
        Tmdt1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Transmit mailbox data byte 2"]
    #[inline(always)]
    pub fn tmdt2(&mut self) -> Tmdt2W<'_, Tmdtl2Spec> {
        Tmdt2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Transmit mailbox data byte 3"]
    #[inline(always)]
    pub fn tmdt3(&mut self) -> Tmdt3W<'_, Tmdtl2Spec> {
        Tmdt3W::new(self, 24)
    }
}
#[doc = "Transmit mailbox 2 low byte data register\n\nYou can [`read`](crate::Reg::read) this register and get [`tmdtl2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tmdtl2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
