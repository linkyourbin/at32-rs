...
impl W {
    #[doc = "Bit 0 - Transmit mailbox send request"]
    #[inline(always)]
    pub fn tmsr(&mut self) -> TmsrW<'_, Tmi2Spec> {
        TmsrW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit mailbox frame type select"]
    #[inline(always)]
    pub fn tmfrsel(&mut self) -> TmfrselW<'_, Tmi2Spec> {
        TmfrselW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit mailbox identifier type select"]
    #[inline(always)]
    pub fn tmidsel(&mut self) -> TmidselW<'_, Tmi2Spec> {
        TmidselW::new(self, 2)
    }
    #[doc = "Bits 3:20 - Ttransmit mailbox extended identifier"]
    #[inline(always)]
    pub fn tmeid(&mut self) -> TmeidW<'_, Tmi2Spec> {
        TmeidW::new(self, 3)
    }
    #[doc = "Bits 21:31 - Transmit mailbox standard identifier or extended identifier high bytes"]
    #[inline(always)]
    pub fn tmsid(&mut self) -> TmsidW<'_, Tmi2Spec> {
        TmsidW::new(self, 21)
    }
}
