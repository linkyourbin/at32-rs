...
impl W {
    ...
    #[doc = "Bit 20 - Channel 6 Global flag clear"]
    #[inline(always)]
    pub fn gfc6(&mut self) -> Gfc6W<'_, ClrSpec> {
        Gfc6W::new(self, 20)
    }
    #[doc = "Bit 21 - Channel 6 full data transfer flag clear"]
    #[inline(always)]
    pub fn fdtfc6(&mut self) -> Fdtfc6W<'_, ClrSpec> {
        Fdtfc6W::new(self, 21)
    }
    #[doc = "Bit 22 - Channel 6 half data transfer flag clear"]
    #[inline(always)]
    pub fn hdtfc6(&mut self) -> Hdtfc6W<'_, ClrSpec> {
        Hdtfc6W::new(self, 22)
    }
    #[doc = "Bit 23 - Channel 6 data transfer error flag clear"]
    #[inline(always)]
    pub fn dterrfc6(&mut self) -> Dterrfc6W<'_, ClrSpec> {
        Dterrfc6W::new(self, 23)
    }
    #[doc = "Bit 24 - Channel 7 Global flag clear"]
    #[inline(always)]
    pub fn gfc7(&mut self) -> Gfc7W<'_, ClrSpec> {
        Gfc7W::new(self, 24)
    }
    #[doc = "Bit 25 - Channel 7 full data transfer flag clear"]
    #[inline(always)]
    pub fn fdtfc7(&mut self) -> Fdtfc7W<'_, ClrSpec> {
        Fdtfc7W::new(self, 25)
    }
    #[doc = "Bit 26 - Channel 7 half data transfer flag clear"]
    #[inline(always)]
    pub fn hdtfc7(&mut self) -> Hdtfc7W<'_, ClrSpec> {
        Hdtfc7W::new(self, 26)
    }
    #[doc = "Bit 27 - Channel 7 data transfer error flag clear"]
    #[inline(always)]
    pub fn dterrfc7(&mut self) -> Dterrfc7W<'_, ClrSpec> {
