...
impl W {
    #[doc = "Bits 0:7 - CH1 SRC select"]
    #[inline(always)]
    pub fn ch1_src(&mut self) -> Ch1SrcW<'_, DmaSrcSel0Spec> {
        Ch1SrcW::new(self, 0)
    }
    #[doc = "Bits 8:15 - CH2 SRC select"]
    #[inline(always)]
    pub fn ch2_src(&mut self) -> Ch2SrcW<'_, DmaSrcSel0Spec> {
        Ch2SrcW::new(self, 8)
    }
    #[doc = "Bits 16:23 - CH3 SRC select"]
    #[inline(always)]
    pub fn ch3_src(&mut self) -> Ch3SrcW<'_, DmaSrcSel0Spec> {
        Ch3SrcW::new(self, 16)
    }
    #[doc = "Bits 24:31 - CH4 SRC select"]
    #[inline(always)]
    pub fn ch4_src(&mut self) -> Ch4SrcW<'_, DmaSrcSel0Spec> {
        Ch4SrcW::new(self, 24)
    }
}
