...
impl W {
    #[doc = "Bit 0 - Core soft reset"]
    #[inline(always)]
    pub fn csrst(&mut self) -> CsrstW<'_, CtrlSpec> {
        CsrstW::new(self, 0)
    }
    #[doc = "Bit 1 - Disable usb phy"]
    #[inline(always)]
    pub fn disusb(&mut self) -> DisusbW<'_, CtrlSpec> {
        DisusbW::new(self, 1)
    }
    #[doc = "Bit 2 - Low power mode"]
    #[inline(always)]
    pub fn lpm(&mut self) -> LpmW<'_, CtrlSpec> {
        LpmW::new(self, 2)
    }
    #[doc = "Bit 3 - Soft suspend config"]
    #[inline(always)]
    pub fn ssp(&mut self) -> SspW<'_, CtrlSpec> {
        SspW::new(self, 3)
    }
    #[doc = "Bit 4 - Generate resume request"]
    #[inline(always)]
    pub fn gresume(&mut self) -> GresumeW<'_, CtrlSpec> {
        GresumeW::new(self, 4)
    }
    #[doc = "Bit 8 - Lost start of frame interrupt enable"]
    #[inline(always)]
    pub fn lsofien(&mut self) -> LsofienW<'_, CtrlSpec> {
        LsofienW::new(self, 8)
    }
    #[doc = "Bit 9 - Start of frame interrupt enable"]
    #[inline(always)]
    pub fn sofien(&mut self) -> SofienW<'_, CtrlSpec> {
        SofienW::new(self, 9)
    }
    #[doc = "Bit 10 - Bus reset interrupt enable"]
    #[inline(always)]
    pub fn rstien(&mut self) -> RstienW<'_, CtrlSpec> {
        RstienW::new(self, 10)
    }
    #[doc = "Bit 11 - Bus suspend mode interrupt enable"]
    #[inline(always)]
    pub fn spien(&mut self) -> SpienW<'_, CtrlSpec> {
        SpienW::new(self, 11)
    }
    #[doc = "Bit 12 - Wakeup/Remote wakeup interrupt enable"]
    #[inline(always)]
    pub fn wkien(&mut self) -> WkienW<'_, CtrlSpec> {
        WkienW::new(self, 12)
    }
    #[doc = "Bit 13 - Bus error interrupt enable"]
    #[inline(always)]
    pub fn beien(&mut self) -> BeienW<'_, CtrlSpec> {
        BeienW::new(self, 13)
    }
    #[doc = "Bit 14 - USB Core fifo overrun interrupt enable"]
    #[inline(always)]
    pub fn ucforien(&mut self) -> UcforienW<'_, CtrlSpec> {
        UcforienW::new(self, 14)
    }
    #[doc = "Bit 15 - transmission completed interrupt enable"]
    #[inline(always)]
    pub fn tcien(&mut self) -> TcienW<'_, CtrlSpec> {
        TcienW::new(self, 15)
    }
}
