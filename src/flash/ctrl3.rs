...
impl W {
    #[doc = "Bit 0 - Flash program"]
    #[inline(always)]
    pub fn fprgm(&mut self) -> FprgmW<'_, Ctrl3Spec> {
        FprgmW::new(self, 0)
    }
    #[doc = "Bit 1 - Sector erase"]
    #[inline(always)]
    pub fn secers(&mut self) -> SecersW<'_, Ctrl3Spec> {
        SecersW::new(self, 1)
    }
    #[doc = "Bit 2 - Chip erase"]
    #[inline(always)]
    pub fn chpers(&mut self) -> ChpersW<'_, Ctrl3Spec> {
        ChpersW::new(self, 2)
    }
    #[doc = "Bit 6 - Erasing start"]
    #[inline(always)]
    pub fn erstr(&mut self) -> ErstrW<'_, Ctrl3Spec> {
        ErstrW::new(self, 6)
    }
    #[doc = "Bit 7 - Operation lock"]
    #[inline(always)]
    pub fn oplk(&mut self) -> OplkW<'_, Ctrl3Spec> {
        OplkW::new(self, 7)
    }
    #[doc = "Bit 10 - Error interrupt enable"]
    #[inline(always)]
    pub fn errie(&mut self) -> ErrieW<'_, Ctrl3Spec> {
        ErrieW::new(self, 10)
    }
    #[doc = "Bit 12 - Operation done flag interrupt enable"]
    #[inline(always)]
    pub fn odfie(&mut self) -> OdfieW<'_, Ctrl3Spec> {
        OdfieW::new(self, 12)
    }
}
