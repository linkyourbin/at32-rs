...
impl W {
    ...
    #[inline(always)]
    pub fn tpefclr(&mut self) -> TpefclrW<'_, CtrlstsSpec> {
        TpefclrW::new(self, 0)
    }
    #[doc = "Bit 1 - Tamper interrupt flag clear"]
    #[inline(always)]
    pub fn tpifclr(&mut self) -> TpifclrW<'_, CtrlstsSpec> {
        TpifclrW::new(self, 1)
    }
    #[doc = "Bit 2 - Tamper pin interrupt enable"]
    #[inline(always)]
    pub fn tpien(&mut self) -> TpienW<'_, CtrlstsSpec> {
        TpienW::new(self, 2)
    }
    #[doc = "Bit 8 - Tamper event flag"]
    #[inline(always)]
    pub fn tpef(&mut self) -> TpefW<'_, CtrlstsSpec> {
        TpefW::new(self, 8)
    }
    #[doc = "Bit 9 - Tamper interrupt flag"]
    #[inline(always)]
    pub fn tpif(&mut self) -> TpifW<'_, CtrlstsSpec> {
        TpifW::new(self, 9)
    }
}
